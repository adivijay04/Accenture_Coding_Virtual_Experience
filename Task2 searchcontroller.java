...
/**
 * This class is the entrypoint for the /api/products/search API.
 * It is "annotated" with the "RestController" annotation which tells the spring framework that it will be providing API implementations.
 *
 * An annotation is metadata that provides data about the program.  Annotations can be checked for on a class by other classes.
 * In this case, we're telling the spring framework that the SearchController provides API capabilities.
 */
@RestController
